(function($){
	...
	return this.each(function(){
		var _this=$(this);
		var _item=_this.find("a");/*找到触发滑块滑动的元素	*/
		var origin=_this.find("a.cur").index();/*获得当前导航的索引*/
		var _mover=_this.parent().find(".move-bg");/*找到滑块*/
		...
		function move(){
			...
			_mover.queue(
				function(){
					$(this).show().stop(true,true).animate({left:""+Number(cur*defaultser.width+extra)+"px"},defaultser.speed),
